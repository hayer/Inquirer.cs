[build]:     https://github.com/hayer/Inquirer.cs/actions/workflows/dotnet.yml
[build-img]: https://github.com/hayer/Inquirer.cs/actions/workflows/dotnet.yml/badge.svg
...
```shell
Install-Package phu.Inquirer.cs
```
